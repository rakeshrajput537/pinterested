...
class PokesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create poke" do
    assert_difference('Poke.count') do
      post pokes_url, params: { poke: { description: @poke.description, user_id: @poke.user_id } }
    end
  ...
  test "should update poke" do
    patch poke_url(@poke), params: { poke: { description: @poke.description, user_id: @poke.user_id } }
